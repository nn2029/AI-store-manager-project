...
thresholds = rospy.get_param(
    "thresholds", {"Out of Stock": 0, "Very Low Stock": 2, "Low Stock": 5, "In Stock": 10}
)
TIME_THRESHOLD = rospy.get_param("time_threshold", 5 * 60)
...
def main():
    rospy.init_node("product_status_test")
